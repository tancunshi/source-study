...
public class ExporterParameterTests extends AbstractJasperReportsTests {
	...
	public void testParameterParsing() throws Exception {
		...
		AbstractJasperReportsView view = new AbstractJasperReportsView() {
			...
			/**
			 * Merges the configured {@link JRExporterParameter JRExporterParameters} with any specified
			 * in the supplied model data. {@link JRExporterParameter JRExporterParameters} in the model
